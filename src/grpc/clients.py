...
from src.grpc.generated import (
  order_query_pb2,
...
class VenueDirectoryClient(_BaseGrpcClient):
  ...
  async def get_venue_by_id(self, venue_id: int) -> venue_directory_pb2.GetVenueByIdResponse:
    return await self._call(
      self._stub.GetVenueById,
      venue_directory_pb2.GetVenueByIdRequest(venue_id=venue_id),
    )


class OrderQueryClient(_BaseGrpcClient):
  def __init__(self) -> None:
    settings = get_settings()
    super().__init__(
